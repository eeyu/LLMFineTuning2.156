...
print("datasets")
standards_dataset = load_dataset(paths.standards_dataset_checkpoint, split="train[:900000]", token=paths.nomi_read_token)
wiki_dataset = load_dataset(paths.wikipedia_dataset_checkpoint, split="train[:100000]", token=paths.nomi_read_token)
